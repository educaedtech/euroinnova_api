...
@model({
  settings: {idInjection: false, mysql: {schema: 'productos', table: 'familias'}}
})
export class Familias extends Entity {
  @property({
    type: 'number',
    required: true,
  ...
  constructor(data?: Partial<Familias>) {
    super(data);
  }
}

export interface FamiliasRelations {
  // describe navigational properties here
}

export type FamiliasWithRelations = Familias & FamiliasRelations;
