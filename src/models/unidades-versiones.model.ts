...
@model({
  settings: {idInjection: false, mysql: {schema: 'productos', table: 'unidades_versiones'}}
})
export class UnidadesVersiones extends Entity {
  @property({
    type: 'number',
  ...
  @property({
    ...
    jsonSchema: {nullable: false},
    generated: false,
    mysql: {columnName: 'fecha_alta', dataType: 'datetime', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  fechaAlta: string;
  ...
  constructor(data?: Partial<UnidadesVersiones>) {
    super(data);
  }
}

export interface UnidadesVersionesRelations {
  // describe navigational properties here
}

export type UnidadesVersionesWithRelations = UnidadesVersiones & UnidadesVersionesRelations;
