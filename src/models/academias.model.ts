...
@model({
  settings: {idInjection: false, mysql: {schema: 'productos', table: 'academias'}}
})
export class Academias extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<Academias>) {
    super(data);
  }
}

export interface AcademiasRelations {
  // describe navigational properties here
}

export type AcademiasWithRelations = Academias & AcademiasRelations;
