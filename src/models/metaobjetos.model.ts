...
@model({
  settings: {idInjection: false, mysql: {schema: 'productos', table: 'metaobjetos'}}
})
export class Metaobjetos extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<Metaobjetos>) {
    super(data);
  }
}

export interface MetaobjetosRelations {
  // describe navigational properties here
}

export type MetaobjetosWithRelations = Metaobjetos & MetaobjetosRelations;
