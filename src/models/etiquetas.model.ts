...
@model({
  settings: {idInjection: false, mysql: {schema: 'productos', table: 'etiquetas'}}
})
export class Etiquetas extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<Etiquetas>) {
    super(data);
  }
}

export interface EtiquetasRelations {
  // describe navigational properties here
}

export type EtiquetasWithRelations = Etiquetas & EtiquetasRelations;
