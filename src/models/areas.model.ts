...
@model({settings: {idInjection: false, mysql: {schema: 'productos', table: 'areas'}}})
export class Areas extends Entity {
  @property({
    type: 'number',
...
export type AreasWithRelations = Areas & AreasRelations;
